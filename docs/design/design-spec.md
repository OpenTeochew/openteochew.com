...
**OpenTeochew** (潮州話開放資料庫) is an open-source platform for Teochew (潮州話) language resources. It aggregates dictionaries, corpora, and texts into a unified digital platform.
