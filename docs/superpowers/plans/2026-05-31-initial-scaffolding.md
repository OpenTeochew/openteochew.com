...
<head>
  ...
  <title>潮州話開放資料庫 OpenTeochew</title>
</head>
  ...
  <div class="min-h-screen flex flex-col">
    ...
    <footer class="py-6 border-t border-kami-border text-center text-muted text-sm">
      <div class="max-w-container mx-auto px-8">
        <p>&copy; 2026 OpenTeochew 潮州話開放資料庫</p>
      </div>
    </footer>
  </div>
</template>
...
<template>
  <div class="max-w-container mx-auto px-8 py-16">
    <h1 class="font-display text-5xl font-medium text-fg mb-4">潮州話開放資料庫</h1>
